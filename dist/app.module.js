...
const detran_module_1 = require("./detran/detran.module");
        ...
        imports: [
            ...
            mongoose_1.MongooseModule.forRootAsync({
                ...
                useFactory: (configService) => ({
                    uri: configService.get('MONGODB_URI', 'mongodb://localhost:27017/gestor-frota-pr'),
                }),
